...
int main() {
  ...
  /*  
    ...
    std::vector<double> reconstructedArray = convertPositArrayToDouble(divPosit, "divPosit.txt");
    ...
    // Compute SNRs
    double snrPosit = computeSNR(divDouble, reconstructedArray);
    double snrFloat = computeSNRFloat(divDouble, divFloat);
