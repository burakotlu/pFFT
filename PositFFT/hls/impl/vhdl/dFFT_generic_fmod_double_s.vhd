...
entity dFFT_generic_fmod_double_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of dFFT_generic_fmod_double_s is 
...
attribute shreg_extract : string;
    ...
    component dFFT_generic_fmod_double_Pipeline_1 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component dFFT_ctlz_54_54_1_1 IS
    generic (
        din_WIDTH : INTEGER;
        dout_WIDTH : INTEGER );
    port (
...
begin
    grp_generic_fmod_double_Pipeline_1_fu_87 : component dFFT_generic_fmod_double_Pipeline_1
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ctlz_54_54_1_1_U4 : component dFFT_ctlz_54_54_1_1
    generic map (
        din_WIDTH => 54,
        dout_WIDTH => 54)
    port map (
