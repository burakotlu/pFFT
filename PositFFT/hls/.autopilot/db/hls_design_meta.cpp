...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("signal_r", 64, hls_in, 0, "ap_none", "in_data", 1),
	...
	Port_Property("result_real_d0", 64, hls_out, 1, "ap_memory", "mem_din", 1),
	...
	Port_Property("result_imag_d0", 64, hls_out, 2, "ap_memory", "mem_din", 1),
};
