set moduleName generic_fmod_double_s
set isTopModule 0
...
set cdfgNum 5
set C_modelName {generic_fmod<double>}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_generic_fmod_double_Pipeline_1_fu_87", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_generic_fmod_double_Pipeline_1_fu_87.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ctlz_54_54_1_1_U4", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "2102"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "2102"}
]}
