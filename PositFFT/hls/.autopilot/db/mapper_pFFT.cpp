...
using hls::sim::Byte;
extern "C" void pFFT(volatile void *, Byte<8>*, Byte<8>*);
extern "C" void apatb_pFFT_hw(volatile void * __xlx_apatb_param_signal_r, volatile void * __xlx_apatb_param_result_real, volatile void * __xlx_apatb_param_result_imag) {
...
__xlx_result_imag__tmp_vec.push_back(((Byte<8>*)__xlx_apatb_param_result_imag)[i]);
  ...
  // DUT call
  pFFT(__xlx_apatb_param_signal_r, __xlx_result_real__tmp_vec.data(), __xlx_result_imag__tmp_vec.data());
