...
module dIFFT_generic_fmod_double_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
dIFFT_flow_control_loop_pipe_sequential_init flow_control_loop_pipe_sequential_init_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
...
endmodule //dIFFT_generic_fmod_double_Pipeline_1
