...
HLS_SOURCES = ../../../../posit_fft_test.cpp ../../../../posit_lib.cpp
...
$(ObjDir)/posit_fft_test.o: ../../../../posit_fft_test.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../posit_fft_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/posit_fft_test.d

$(ObjDir)/posit_lib.o: ../../../../posit_lib.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../posit_lib.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/posit_lib.d
